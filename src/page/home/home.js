      ...
      <View style={{flex: 1}}>
        ...
        <ScrollView
          ...
          <Carousel
            ...
            <Image
              source={{
                uri:
                  'https://api.youzixy.com/public/uploads/attach/2019/09/16/5d7f9df01b29f.jpg',
              }}
            ...
            <Image
              ...
              source={{
                uri:
                  'https://api.youzixy.com/public/uploads/attach/2019/09/16/5d7f9df9c8ffd.jpg',
              }}
            />
            <Image
              style={{width: '100%', height: 120}}
              source={{
                uri:
                  'https://api.youzixy.com/public/uploads/attach/2019/09/16/5d7f9de20f273.jpg',
              }}
            />
          </Carousel>
          <Grid
          ...
          <Text style={{paddingLeft: 10}}>
            <Image
              source={require('../../../android/app/src/main/res/drawable-hdpi/life.png')}
          ...
          <View style={style.flex}>
            ...
            <View style={style.SchoolHotBg}>
              <TouchableOpacity
                ...
                style={{flexDirection: 'column'}}
                activeOpacity={0.6}
                onPress={() => this.props.navigation.push('Job')}>
                <Text style={style.SchoolHotTitle}>学生兼职</Text>
                <Text style={style.SchoolHotDescribe}>校园兼职</Text>
                <View style={{flex: 1}} />
                <Text style={style.SchoolClickLook}>点击查看 {'>'}</Text>
            ...
            <View style={style.SchoolHotBg}>
              <TouchableOpacity
                style={{flexDirection: 'column'}}
                activeOpacity={0.6}
                onPress={() => this.props.navigation.push('HotNews')}>
        ...
        {this.state.isTop === true ? (
          <ActionButton
            renderIcon={() => (
              <Image
                source={require('../../../android/app/src/main/res/drawable-hdpi/gotop.png')}

...
import {reqConditionFindJob} from '../../api/index';
import {SearchBar} from '@ant-design/react-native';
import {ChangePage, Foot, BackTop, JobList} from '../../utils/ChangePage';
...
export default class Job extends Component {
  ...
  getAllProduct = async page => {
    ...
    condition.page = page;
    condition.rows = 5;
    condition.name = this.state.searchName;
    ...
    return (
      <View style={{flex: 1}}>
        ...
        <ScrollView
          ...
          <JobList JobList={this.state.AllProduct} props={this.props} />

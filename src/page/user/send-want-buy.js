...
class SendWantBuy extends Component {
  ...
  saveProduct = async () => {
    ...
    if (
      ...
      const result =
        type === 'MyUser'
          ? await reqUpdateWantBuy(wantBuy, token)
          : await reqSaveWantBuy(wantBuy, token);
      if (result.code === 0) {
      ...
      <View style={{flex: 1, backgroundColor: '#FFFFFF'}}>
        ...
        <List>
          <InputItem
            ...
            extra={
              <Text style={{fontSize: 13, color: '#778899'}}>引人注目</Text>
            }
          ...
          <InputItem
            ...
            style={{paddingLeft: 15}}
            extra={
              <Text style={{fontSize: 13, color: '#778899'}}>方便联系您</Text>
            }
          ...
          <InputItem
            ...
            extra={
              <Text style={{fontSize: 13, color: '#778899'}}>开个最低价</Text>
            }
          ...
          <InputItem
            ...
            style={{paddingLeft: 30}}
            extra={
              <Text style={{fontSize: 13, color: '#778899'}}>开个最高价</Text>
            }
...
export default connect(mapStateToProps)(SendWantBuy);

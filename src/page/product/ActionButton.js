           ...
           keyboard === false ?
                ProductUserId === MyUserId ?
                    <ActionButton buttonColor="rgba(231,76,60,1)" position='right' verticalOrientation='up'>
                        <ActionButton.Item buttonColor='#9b59b6' onPress={() => this.hideButton()}>
                        ...
                        <ActionButton.Item buttonColor='#1abc9c' onPress={() => this.UpOrDownProduct()}>
                            <Text style={{color: '#FFFFFF'}}>{detail.state === 0 ? '下架' : '上架'}</Text>
                        </ActionButton.Item>
                    </ActionButton> :
                    <ActionButton
                        buttonColor="#36B7AB"
